...
pygame.display.set_caption('ALIEN SPACE INVADER')
...
LASER_GREEN = pygame.image.load('pixel_laser_green.png')
LASER_RED = pygame.image.load('pixel_laser_red.png')
LASER_BLUE = pygame.image.load('pixel_laser_blue.png')
LASER_YELLOW = pygame.image.load('pixel_laser_yellow.png')
